    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="row my-5 p-4" >
                <div class="col">
                    <h3 class="fs-4 mb-3"><a style="text-decoration: none; color: inherit;"
                            href="{{ route('admins.etudiants') }}">All Users</a></h3>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->usertype }}</td>
                                    <td>
                                        <a href="{{ route('etudiants.show', $user) }}"
                                            class="btn btn-info">View</a>
                                        <a href="{{ route('etudiants.edit', $user) }}"
                                            class="btn btn-primary">Edit</a>
                                        <form action="{{ route('etudiants.destroy', $user) }}" method="POST"
                                            style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger"
                                                onclick="return confirm('Are you sure you want to delete this etudiant?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
